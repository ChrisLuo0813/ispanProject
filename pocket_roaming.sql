...
CREATE TABLE `members` (
  ...
  `member_account` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `member_password` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `member_email` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `member_phonenumber` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `member_birthday` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  ...
  `member_rank` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `member_ban_date` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `member_token` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `member_balance` int(255) DEFAULT NULL,
  `account_create_time` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `last_login_time` varchar(20) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `members` (`member_id`, `member_account`, `member_password`, `member_email`, `member_phonenumber`, `member_birthday`, `member_region`, `member_rate`, `member_icon`, `member_nickname`, `member_introduction`, `member_rank`, `member_ban_date`, `member_token`, `member_balance`, `account_create_time`, `last_login_time`) VALUES
(1, 'brad0101', '$2a$10$XerB/XuSgzENfhEQi3tGeOyJkYhSBMdcCF30lFF9HByTElUaikzAO', 'tel2855973@hotmail.com', '912345678', NULL, '台中市', NULL, NULL, '布萊德', '遊戲愛好者，收藏多種主機與多款遊戲，歡迎交流與許願', '2', NULL, '1', NULL, '2022-10-04 15:45:53', '2022-10-06 15:31:11'),
(2, 'shitter', '98765432', 'GG@gmail.com', '965789456', '1988-09-04', NULL, 5, NULL, '雪特', '安安', '1', NULL, '3', NULL, '2022/09/21-16:08:17', '2022/09/23-21:55:06'),
(3, 'wolfgang', '$2a$10$ecXbing46JLGYMCWtlN26Otqb7n02ohxGJvgjUKVypuCLsRJi0rlu', 'tel2855973@hotmail.com', '988756498', NULL, '台中', 4.7, NULL, '曼尼', NULL, '1', NULL, '2', NULL, '2022/09/23-09:15:39', '2022-10-06 16:44:18'),
(4, 'admin01', 'admin01', 'admin01@hotmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '3', NULL, '1', NULL, '2022/09/15-00:00:00', '2022/09/23-14:10:24'),
(5, 'Tomcat123', 'Tomcat@cat.tw', 'Tomcat@cat.tw', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, 'Tomcat124', 'Tomcatcat@cat.tw', 'Tomcatcat@cat.tw', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, 'Tomcat129', 'Tomcatcatcat@cat.tw', 'Tomcatcatcat@cat.tw', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(8, 'Tomcat100', 'Tomcat111111@cat.tw', 'Tomcat111111@cat.tw', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(10, 'Good123', 'Good123@good.tw', 'Good123@good.tw', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-270 04:11:18', '2022-09-270 04:11:18'),
(11, 'Vincent500', 'Vincent500@gmail.com', 'Vincent500@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-27 04:14:42', '2022-09-27 04:14:42'),
(12, 'Andy558', 'Andy558@andy.com', 'Andy558@andy.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-27 16:18:10', '2022-09-27 16:18:10'),
(13, 'Mary123', '$2a$10$ufLzH9Vivn3redb4RW0av.J.MGDWQE0yvgla1MRu80SEpIhNCYuZ2', 'marycat@dog.com', NULL, '2022-10-05', '台北縣', NULL, '20221005153723_123456789.jpg', '瑪莉莉', '喜歡看小說，交朋友，歡迎聊天喔', NULL, NULL, NULL, NULL, '2022-09-29 11:45:09', '2022-10-05 15:37:23'),
(14, 'Disco005', '$2a$10$x2Wqh9r4dlJjkwmXO0T7eumMmrSkiDHOkimA1916veNqT8U/Ipp4C', 'Disco005@ttt.com.tw', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2', NULL, NULL, NULL, '2022-10-03 15:32:31', '2022-10-03 15:32:31'),
(15, 'AAAAAAA', '$2a$10$gOrx3h4F1/UCYVvwZfmUvOAokkugqmuHiC5Ui6S/uRyxXWCbc1tTy', 'AAAAAA@AAA.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2', NULL, NULL, NULL, '2022-10-06 12:00:47', NULL);
...
CREATE TABLE `order_details` (
  ...
  `item_id` int(20) DEFAULT NULL,
  `item_receive_date` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `deliver_way` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `deliver_place` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `item_return_date` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `return_way` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `return_place` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `item_price` int(20) DEFAULT NULL,
...
INSERT INTO `order_details` (`order_detail_id`, `order_id`, `item_id`, `item_receive_date`, `deliver_way`, `deliver_place`, `item_return_date`, `return_way`, `return_place`, `item_price`, `is_violate`, `violate_type`) VALUES
(1, 1, 1, '20220925', '全家店到店', '全家台中育德店', '20221001', '全家店到店', '全家台中大英店', 35, 2, NULL),
(2, 1, 2, '20220925', '全家店到店', '全家台中育德店', '20221001', '全家店到店', '全家台中精誠店', 560, 2, NULL),
(3, 2, 2, '20221004', '7-11店到店', '7-ELEVEN 鄉林門市', '20221011', '7-11店到店', '7-ELEVEN 隆安門市', 560, 2, NULL),
(4, 2, 4, '20221004', '7-11店到店', '7-ELEVEN 鄉林門市', '20221011', '7-11店到店', '7-ELEVEN 隆安門市', 350, 2, NULL);
...
CREATE TABLE `order_list` (
  ...
  `member_id` int(20) DEFAULT NULL,
  `order_date` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  ...
  `order_state` varchar(20) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
(1, 1, '2022-09-23', 2, 120, 715, '1', '2'),
(2, 2, '2022-09-23', 2, 120, 1030, '2', '3');
...
--
ALTER TABLE `items`
  MODIFY `item_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `item_picture`
--
ALTER TABLE `item_picture`
  MODIFY `picture_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `order_details`
  MODIFY `order_detail_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
